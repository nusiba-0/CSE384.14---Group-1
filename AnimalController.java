...
import org.example.meowwoof.service.AnimalService;
...
public class AnimalController {
   ...
   public List<Animal> getAnimalsByArea(@PathVariable Integer areaId) {
       return animalService.getAnimalsByArea(areaId);
   }


   @GetMapping("/unhealthy")
   public List<Animal> getUnhealthyAnimals() {
       return animalService.getUnhealthyAnimals();
   }
